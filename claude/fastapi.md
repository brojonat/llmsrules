...
After you make updates to the server code, look for an adjacent README.md file and make any necessary updates to it so that the README is an accurate description of the server's behavior.
